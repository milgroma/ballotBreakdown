...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { district: @office.district, office: @office.office, term_limit: @office.term_limit, territory: @office.territory, tier: @office.tier }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { district: @office.district, office: @office.office, term_limit: @office.term_limit, territory: @office.territory, tier: @office.tier }
    assert_redirected_to office_path(assigns(:office))
  end
